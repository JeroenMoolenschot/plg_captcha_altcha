...
var vi = (e, t, r) => t in e ? di(e, t, {
  enumerable: !0,
  configurable: !0,
  writable: !0,
  value: r
}) : e[t] = r;
var re = (e, t, r) => vi(e, typeof t != "symbol" ? t + "" : t, r),
  zr = (e, t, r) => t.has(e) || Pr("Cannot " + r);
var Y = (e, t, r) => (zr(e, t, "read from private field"), r ? r.call(e) : t.get(e)),
  Mt = (e, t, r) => t.has(e) ? Pr("Cannot add the same private member more than once") : t instanceof WeakSet ? t.add(e) : t.set(e, r),
  qt = (e, t, r, l) => (zr(e, t, "write to private field"), l ? l.call(e, r) : t.set(e, r), r);
const hi = "5";
...
function sn(e, t) {
  ...
  if (r !== null) for (var l = r.length, i = 0; i < l; i++) {
    var o = r[i],
      a = o.f;
    a & xe || (ve(o, t), a & (Z | Ne) && (a & le ? sn(/** @type {Derived} */
    o, _t) : Lt(/** @type {Effect} */
    o)));
  }
}
...
let D;
function $e(e) {
  if (e === null) throw It(), He;
  return D = e;
}
function Ge() {
  return $e(/** @type {TemplateNode} */
  /* @__PURE__ */Ce(D));
}
function G(e) {
  if (P) {
    if (/* @__PURE__ */Ce(D) !== null) throw It(), He;
    D = e;
  }
}
function Vi() {
...
function ie(e, t = null, r) {
  ...
  const l = Ut(e);
  if (l !== xi && l !== $i) return e;
  var i = /* @__PURE__ */new Map(),
    o = Xr(e),
    a = fe(0);
  o && i.set("length", fe(/** @type {any[]} */
  e.length));
  var d;
  ...
  e, {
    ...
    deleteProperty(u, c) {
      var f = i.get(c);
      if (f === void 0) c in u && i.set(c, fe(W));else {
    ...
    has(u, c) {
      ...
      if (c === ut) return !0;
      var f = i.get(c),
        h = f !== void 0 && f.v !== W || Reflect.has(u, c);
    ...
    set(u, c, f, h) {
      ...
      var _ = i.get(c),
        m = c in u;
      if (o && c === "length") for (var w = f; w < /** @type {Source<number>} */
      _.v; w += 1) {
        var T = i.get(w + "");
    ...
    ownKeys(u) {
      ...
      for (var [f, h] of i) h.v !== W && !(f in u) && c.push(f);
      return c;
    },
    setPrototypeOf() {
      zi();
...
function at(e) {
  var t = le | xe;
  y === null ? t |= Ne : y.f |= tn;
  var r = C !== null && C.f & le ? (/** @type {Derived} */
  C) : null;
  const l = {
    children: null,
    ctx: U,
...
function ji(e) {
  for (var t = e.parent; t !== null;) {
    if (!(t.f & le)) return /** @type {Effect} */t;
    t = t.parent;
  }
  return null;
}
...
function Le(e, t = !0) {
  ...
  if ((t || e.f & Ci) && e.nodes_start !== null) {
    for (var l = e.nodes_start, i = e.nodes_end; l !== null;) {
      var o = l === i ? null : (/** @type {TemplateNode} */
      /* @__PURE__ */Ce(l));
      l.remove(), l = o;
    }
    r = !0;
...
function Zi(e, t) {
  ...
  if (r > 0) {
    var l = () => --r || t();
    for (var i of e) i.out(l);
  } else t();
}
function yn(e, t, r) {
  if (!(e.f & Ze)) {
    if (e.f ^= Ze, e.transitions !== null) for (const a of e.transitions) (a.is_global || r) && t.push(a);
...
function gt(e) {
  ...
  if (t & _t) {
    ...
    if (r !== null) {
      var i;
      if (t & kt) {
        for (i = 0; i < r.length; i++) ((a = r[i]).reactions ?? (a.reactions = [])).push(e);
        e.f ^= kt;
      }
      for (i = 0; i < r.length; i++) {
        ...
        if (gt(/** @type {Derived} */
        o) && vn(/** @type {Derived} */
        o), l && y !== null && !Be && !((d = o == null ? void 0 : o.reactions) != null && d.includes(e)) && (o.reactions ?? (o.reactions = [])).push(e), o.version > e.version) return !0;
      }
    }
    l || ve(e, Z);
  }
...
function An(e) {
  ...
  try {
    ...
    if (V !== null) {
      var h;
      if (dt(e, X), f !== null && X > 0) for (f.length = X + V.length, h = 0; h < V.length; h++) f[X + h] = V[h];else e.deps = f = V;
      if (!Be) for (h = X; h < f.length; h++) ((_ = f[h]).reactions ?? (_.reactions = [])).push(e);
...
function il(e, t) {
  ...
  V === null || !V.includes(t)) && (ve(t, _t), t.f & (Ne | kt) || (t.f ^= kt), dt(/** @type {Derived} **/
  t, 0));
}
function dt(e, t) {
  var r = e.deps;
  if (r !== null) for (var l = t; l < r.length; l++) il(e, r[l]);
}
function Nt(e) {
  var t = e.f;
  if (!(t & Ke)) {
...
function Rn() {
  if (We > 1e3) {
    ...
    try {
      ...
      if (ct !== null) Tt(e, ct, null);else throw e;
    }
  }
  We++;
}
...
function Sn(e, t) {
  ...
  for (var f = 0; f < l.length; f++) u = l[f], t.push(u), Sn(u, t);
}
function $(e) {
  var t = bt,
    r = Ie;
...
function v(e) {
  ...
  var t = e.f,
    r = (t & le) !== 0;
  if (r && t & Ke) {
    var l = dn(/** @type {Derived} */
    e);
    return Xt(/** @type {Derived} */
    e), l;
  }
  if (C !== null) {
  ...
  e.deps === null) for (var o = /** @type {Derived} */
    e, a = o.parent, d = o; a !== null;) if (a.f & le) {
    var u = /** @type {Derived} */
    a;
    d = u, a = u.parent;
  } else {
...
function Ln() {
  jr || (jr = !0, document.addEventListener("reset", e => {
    Promise.resolve().then(() => {
      var t;
      if (!e.defaultPrevented) for (const r of /**@type {HTMLFormElement} */
      e.target.elements) (t = r.__on_r) == null || t.call(r);
    });
  },
...
function fl(e, t, r, l) {
  function i(o) {
    if (l.capture || st.call(t, o), !o.cancelBubble) return Dn(() => r.call(this, o));
  }
...
function gl(e, t) {
  ...
  const r = t.target,
    ...
    i = D;
  try {
    for (var o = /** @type {TemplateNode} */
    /* @__PURE__ */Te(r); o && (o.nodeType !== 8 || /** @type {Comment} */
    o.data !== Zr);) o = /** @type {TemplateNode} */
    /* @__PURE__ */Ce(o);
    if (!o) throw He;
    je(!0), $e(/** @type {Comment} */
    o), Ge();
    ...
    D.data !== Jr) throw It(), He;
    return je(!1), /**  @type {Exports} */
    a;
  } catch (a) {
    if (a === He) return t.recover === !1 && Li(), Bt(), Ui(r), je(!1), On(e, t);
    throw a;
  } finally {
    je(l), $e(i);
  }
    ...
    u = h => {
      for (var _ = 0; _ < h.length; _++) {
        ...
        if (!d.has(m)) {
          d.add(m);
          var w = _l(m);
          t.addEventListener(m, st, {
            passive: w
          });
          var T = Ve.get(m);
          T === void 0 ? (document.addEventListener(m, st, {
            passive: w
          }), Ve.set(m, 1)) : Ve.set(m, T + 1);
        }
      }
    };
  u(bi(Pn)), Zt.add(u);
  var c = void 0,
    f = hn(() => {
      ...
      return Ct(() => {
        if (o) {
          Tn({});
          var _ = /** @type {ComponentContext} */
          U;
          _.c = o;
        }
        i && (l.$$events = i), P && Ee(/** @type {TemplateNode} */
        h, null), c = e(h, l) || {}, P && (y.nodes_end = D), o && Nn();
      }), () => {
        var w;
        for (var _ of d) {
  ...
  tr(() => {
    ...
    d !== void 0 && (Le(d), d = void 0), a !== "" && (d = Ct(() => {
      if (P) {
        ...
        u.data !== "");) c = u, u = /** @type {TemplateNode} */
        /* @__PURE__ */Ce(u);
        if (u === null) throw It(), He;
        Ee(D, c), o = $e(u);
        return;
      }
      var f = a + "",
        h = zn(f);
      Ee(/** @type {TemplateNode} */
      /* @__PURE__ */Te(h), /** @type {TemplateNode} */
      h.lastChild), o.before(h);
    }));
  });
}
function pl(e, t, r, l, i) {
  var d;
  P && Ge();
  var o = (d = t.$$slots) == null ? void 0 : d[r],
    a = !1;
...
function Cl(e) {
  for (var t = y, r = y; t !== null && !(t.f & (oe | ht));) t = t.parent;
  try {
    return de(t), e();
  } finally {
    de(r);
...
function S(e, t, r, l) {
  ...
  e[t])) : c = /** @type {V} */
  e[t];
  var f = ut in e || rn in e,
    h = ((me = Se(e, t)) == null ? void 0 : me.set) ?? (f && a && t in e ? A => e[t] = A : void 0),
    _ = /** @type {V} */
    l,
    m = !0,
    w = !1,
    T = () => (w = !0, m && (m = !1, d ? _ = Je(/** @type {() => V} */
    l) : _ = /** @type {V} */
    l), _);
...
class Rl {
  ...
  constructor(t) {
    ...
    for (const a of Object.keys(Y(this, te))) a === "$set" || a === "$destroy" || a === "$on" || $t(this, a, {
      get() {
        return Y(this, te)[a];
      },
      /** @param {any} value */
  ...
  $on(t, r) {
    ...
    return Y(this, ge)[t].push(l), () => {
      Y(this, ge)[t] = Y(this, ge)[t].filter(/** @param {any} fn */
      i => i !== l);
    };
  }
  $destroy() {
...
typeof HTMLElement == "function" && (qn = class extends HTMLElement {
  ...
  constructor(t, r, l) {
    ...
    re(this, "$$me");
    this.$$ctor = t, this.$$s = r, l && this.attachShadow({
      mode: "open"
    });
  }
  /**
  ...
  async connectedCallback() {
    if (this.$$cn = !0, !this.$$c) {
      ...
      const r = {},
        l = Il(this);
      for (const i of this.$$s) i in l && (i === "default" && !this.$$d.children ? (this.$$d.children = t(i), r.default = !0) : r[i] = t(i));
      ...
      this.$$c = Al({
        ...
        er(() => {
          ...
          for (const o of xt(this.$$c)) {
            ...
            this.$$d[o] = this.$$c[o];
            const a = Et(o, this.$$d[o], this.$$p_d, "toAttribute");
            a == null ? this.removeAttribute(this.$$p_d[o].attribute || o) : this.setAttribute(this.$$p_d[o].attribute || o, a);
          }
          this.$$r = !1;
        });
      });
      for (const i in this.$$l) for (const o of this.$$l[i]) {
  ...
  attributeChangedCallback(t, r, l) {
    var i;
    this.$$r || (t = this.$$g_p(t), this.$$d[t] = Et(t, l, this.$$p_d, "toProp"), (i = this.$$c) == null || i.$set({
      [t]: this.$$d[t]
    }));
  }
   ...
   */
  $$g_p(t) {
    return xt(this.$$p_d).find(r => this.$$p_d[r].attribute === t || !this.$$p_d[r].attribute && r.toLowerCase() === t) || t;
  }
});
function Et(e, t, r, l) {
  var o;
...
function Sl(e, t, r, l, i, o) {
  let a = class extends qn {
    ...
    static get observedAttributes() {
      return xt(t).map(d => (t[d].attribute || d).toLowerCase());
    }
  };
...
async function Un(e, t, r) {
  if (typeof crypto > "u" || !("subtle" in crypto) || !("digest" in crypto.subtle)) throw new Error("Web Crypto is not available. Secure context is required (https://developer.mozilla.org/en-US/docs/Web/Security/Secure_Contexts).");
  return Tl(await crypto.subtle.digest(r.toUpperCase(), Vn.encode(e + t)));
}
...
function Pl(e) {
  ...
  for (let l = 0; l < t.length; l++) r[l] = t.charCodeAt(l);
  return r;
}
function zl(e, t = 12) {
  const r = new Uint8Array(t);
  for (let l = 0; l < t; l++) r[l] = e % 256, e = Math.floor(e / 256);
  return r;
}
async function Ol(e, t = "", r = 1e6, l = 0) {
  const i = "AES-GCM",
    ...
    d = async () => {
      for (let f = l; f <= r; f += 1) {
        if (o.signal.aborted || !u || !c) return null;
        try {
  ...
  try {
    c = Pl(e);
    const f = await crypto.subtle.digest("SHA-256", Vn.encode(t));
    u = await crypto.subtle.importKey("raw", f, i, !1, ["decrypt"]);
  } catch {
    return {
...
var x = /* @__PURE__ */(e => (e.ERROR = "error", e.VERIFIED = "verified", e.VERIFYING = "verifying", e.UNVERIFIED = "unverified", e.EXPIRED = "expired", e))(x || {}),
  Fl = /* @__PURE__ */ae('<svg width="24" height="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" class="svelte-ddsc3z"><path d="M12,1A11,11,0,1,0,23,12,11,11,0,0,0,12,1Zm0,19a8,8,0,1,1,8-8A8,8,0,0,1,12,20Z" fill="currentColor" opacity=".25" class="svelte-ddsc3z"></path><path d="M12,4a8,8,0,0,1,7.89,6.7A1.53,1.53,0,0,0,21.38,12h0a1.5,1.5,0,0,0,1.48-1.75,11,11,0,0,0-21.72,0A1.5,1.5,0,0,0,2.62,12h0a1.53,1.53,0,0,0,1.49-1.3A8,8,0,0,1,12,4Z" fill="currentColor" class="altcha-spinner svelte-ddsc3z"></path></svg>'),
  Ml = /* @__PURE__ */ae('<span role="status" aria-live="polite" class="svelte-ddsc3z"><!></span> <input type="hidden" class="svelte-ddsc3z">', 1),
  ql = /* @__PURE__ */ae('<span role="status" aria-live="polite" class="svelte-ddsc3z"><!></span>'),
  Vl = /* @__PURE__ */ae('<label class="svelte-ddsc3z"><!></label>'),
  Ul = /* @__PURE__ */ae('<div class="svelte-ddsc3z"><a target="_blank" class="altcha-logo svelte-ddsc3z"><svg width="22" height="22" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg" class="svelte-ddsc3z"><path d="M2.33955 16.4279C5.88954 20.6586 12.1971 21.2105 16.4279 17.6604C18.4699 15.947 19.6548 13.5911 19.9352 11.1365L17.9886 10.4279C17.8738 12.5624 16.909 14.6459 15.1423 16.1284C11.7577 18.9684 6.71167 18.5269 3.87164 15.1423C1.03163 11.7577 1.4731 6.71166 4.8577 3.87164C8.24231 1.03162 13.2883 1.4731 16.1284 4.8577C16.9767 5.86872 17.5322 7.02798 17.804 8.2324L19.9522 9.01429C19.7622 7.07737 19.0059 5.17558 17.6604 3.57212C14.1104 -0.658624 7.80283 -1.21043 3.57212 2.33956C-0.658625 5.88958 -1.21046 12.1971 2.33955 16.4279Z" fill="currentColor" class="svelte-ddsc3z"></path><path d="M3.57212 2.33956C1.65755 3.94607 0.496389 6.11731 0.12782 8.40523L2.04639 9.13961C2.26047 7.15832 3.21057 5.25375 4.8577 3.87164C8.24231 1.03162 13.2883 1.4731 16.1284 4.8577L13.8302 6.78606L19.9633 9.13364C19.7929 7.15555 19.0335 5.20847 17.6604 3.57212C14.1104 -0.658624 7.80283 -1.21043 3.57212 2.33956Z" fill="currentColor" class="svelte-ddsc3z"></path><path d="M7 10H5C5 12.7614 7.23858 15 10 15C12.7614 15 15 12.7614 15 10H13C13 11.6569 11.6569 13 10 13C8.3431 13 7 11.6569 7 10Z" fill="currentColor" class="svelte-ddsc3z"></path></svg></a></div>'),
  jl = /* @__PURE__ */ae('<div class="svelte-ddsc3z"><!></div>'),
  Bl = /* @__PURE__ */ae('<div class="svelte-ddsc3z"><!></div>'),
  Hl = /* @__PURE__ */ae('<div class="altcha-error svelte-ddsc3z"><svg width="14" height="14" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="svelte-ddsc3z"><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12" class="svelte-ddsc3z"></path></svg> <!></div>'),
  Yl = /* @__PURE__ */ae('<div class="altcha-footer svelte-ddsc3z"><div class="svelte-ddsc3z"><!></div></div>'),
  Wl = /* @__PURE__ */ae('<div class="altcha-anchor-arrow svelte-ddsc3z"></div>'),
  Zl = /* @__PURE__ */ae('<!> <div class="altcha svelte-ddsc3z"><div class="altcha-main svelte-ddsc3z"><!> <div class="altcha-checkbox svelte-ddsc3z"><input type="checkbox" class="svelte-ddsc3z"></div> <div class="altcha-label svelte-ddsc3z"><!></div> <!></div> <!> <!> <!></div>', 1);
const Gl = {
  hash: "svelte-ddsc3z",
...
function Jl(e, t) {
  var Nr, Lr;
  Tn(t, !0), yl(e, Gl);
  let r = S(t, "auto", 7, void 0),
    l = S(t, "blockspam", 7, void 0),
    i = S(t, "challengeurl", 7, void 0),
    o = S(t, "challengejson", 7, void 0),
    a = S(t, "customfetch", 7, void 0),
    d = S(t, "debug", 7, !1),
    u = S(t, "delay", 7, 0),
    c = S(t, "expire", 7, void 0),
    f = S(t, "floating", 7, void 0),
    h = S(t, "floatinganchor", 7, void 0),
    _ = S(t, "floatingoffset", 7, void 0),
    m = S(t, "hidefooter", 7, !1),
    w = S(t, "hidelogo", 7, !1),
    T = S(t, "name", 7, "altcha"),
    O = S(t, "maxnumber", 7, 1e6),
    Q = S(t, "mockerror", 7, !1),
    F = S(t, "obfuscated", 7, void 0),
    j = S(t, "plugins", 7, void 0),
    he = S(t, "refetchonexpire", 7, !0),
    q = S(t, "spamfilter", 7, !1),
    me = S(t, "strings", 7, void 0),
    A = S(t, "test", 7, !1),
    B = S(t, "verifyurl", 7, void 0),
    se = S(t, "workers", 23, () => Math.min(16, navigator.hardwareConcurrency || 8)),
    Qe = S(t, "workerurl", 7, void 0);
  const ir = ["SHA-256", "SHA-384", "SHA-512"],
    lr = "Visit Altcha.org",
    or = "https://altcha.org/",
    et = (n, s) => {
    ...
    ar = (Lr = (Nr = document.documentElement.lang) == null ? void 0 : Nr.split("-")) == null ? void 0 : Lr[0],
    Dt = /* @__PURE__ */at(() => {
      var n;
      return i() && new URL(i(), location.origin).host.endsWith(".altcha.org") && !!((n = i()) != null && n.includes("apiKey=ckey_"));
    }),
    Pt = /* @__PURE__ */at(() => o() ? pr(o()) : void 0),
    sr = /* @__PURE__ */at(() => me() ? pr(me()) : {}),
    ee = /* @__PURE__ */at(() => {
      var n;
      return {
        ariaLinkLabel: lr,
  ...
  Ht(() => {
    ...
    var n;
    I("mounted", "1.2.0"), I("workers", se()), Zn(), I("plugins", pe.length ? pe.map(s => s.constructor.pluginName).join(", ") : "none"), A() && I("using test mode"), c() && zt(c()), r() !== void 0 && I("auto", r()), f() !== void 0 && yr(f()), b = (n = v(H)) == null ? void 0 : n.closest("form"), b && (b.addEventListener("submit", hr, {
      capture: !0
    }), b.addEventListener("reset", _r), r() === "onfocus" && b.addEventListener("focusin", vr)), r() === "onload" && (F() ? rt() : ye()), v(Dt) && (m() || w()) && I("Attributes hidefooter and hidelogo ignored because usage with free API Keys requires attribution."), requestAnimationFrame(() => {
      et("load");
    });
  });
  function ur(n, s) {
  ...
  async function Bn() {
    var n;
    if (Q()) throw I("mocking error"), new Error("Mocked error.");
    if (v(Pt)) return I("using provided json data"), v(Pt);
    if (A()) return I("generating test challenge", {
      test: A()
    }), Nl(typeof A() != "boolean" ? +A() : void 0);
    {
      if (!i() && b) {
        const N = b.getAttribute("action");
        N != null && N.includes("/form/") && i(N + "/altcha");
      }
      if (!i()) throw new Error("Attribute challengeurl not set.");
      I("fetching challenge from", i());
      let s = null,
        g = null;
      if (a()) if (I("using customfetch"), typeof a() == "string") {
        if (s = globalThis[a()] || null, !s) throw new Error(`Custom fetch function not found: ${a()}`);
      } else s = a();
      const E = {
        headers: q() !== !1 ? {
      ...
      if (s) {
        if (g = await s(i(), E), !g || !(g instanceof Response)) throw new Error("Custom fetch function did not return a response.");
      } else g = await fetch(i(), E);
      if (g.status !== 200) throw new Error(`Server responded with ${g.status}.`);
      const z = g.headers.get("X-Altcha-Config"),
        k = await g.json(),
        p = new URLSearchParams((n = k.salt.split("?")) == null ? void 0 : n[1]),
        M = p.get("expires") || p.get("expire");
      if (M) {
        const N = new Date(+M * 1e3),
          Fe = isNaN(N.getTime()) ? 0 : N.getTime() - Date.now();
        Fe > 0 && zt(Fe);
      }
      if (z) try {
  ...
  function Wn(n) {
    return [...((b == null ? void 0 : b.querySelectorAll(n != null && n.length ? n.map(g => `input[name="${g}"]`).join(", ") : 'input[type="text"]:not([data-no-spamfilter]), textarea:not([data-no-spamfilter])')) || [])].reduce((g, E) => {
      const z = E.name,
        k = E.value;
...
`) : k), g;
  ...
  function Zn() {
    ...
    for (const s of globalThis.altchaPlugins) (!n || n.includes(s.pluginName)) && pe.push(new s({
      el: v(H),
      clarify: rt,
      dispatch: et,
      getConfiguration: xr,
  ...
  function Jn(n) {
    for (const s of pe) typeof s.onErrorChange == "function" && s.onErrorChange(v(ze));
  }
  function vr(n) {
    v(R) === x.UNVERIFIED && ye();
  }
  ...
  function Kn(n) {
    for (const s of pe) typeof s.onStateChange == "function" && s.onStateChange(v(R));
  ...
  function mt(n = 20) {
    if (v(H)) if (Pe || (Pe = (h() ? document.querySelector(h()) : b == null ? void 0 : b.querySelector('input[type="submit"], button[type="submit"], button:not([type="button"]):not([type="reset"])')) || b), Pe) {
      const s = parseInt(_(), 10) || 12,
        g = Pe.getBoundingClientRect(),
        E = v(H).getBoundingClientRect(),
        z = document.documentElement.clientHeight,
        k = document.documentElement.clientWidth,
        p = f() === "auto" ? g.bottom + E.height + s + n > z : f() === "top",
        M = Math.max(n, Math.min(k - n - E.width, g.left + g.width / 2 - E.width / 2));
  ...
  async function Xn(n) {
    if (!B()) throw new Error("Attribute verifyurl not set.");
    ...
    if (E != null && E.payload && L(Ae, ie(E.payload)), et("serververification", E), l() && E.classification === "BAD") throw new Error("SpamFilter returned negative classification.");
  }
  function zt(n) {
  ...
  function wr(n) {
    ...
    if (!ir.includes(n.algorithm.toUpperCase())) throw new Error(`Unknown algorithm value. Allowed values: ${ir.join(", ")}`);
  ...
  async function br(n) {
    ...
    if ("Worker" in window) {
      ...
      if ((s == null ? void 0 : s.number) !== void 0 || "obfuscated" in n) return {
        data: n,
        solution: s
      };
    }
  ...
  async function Qn(n, s = typeof A() == "number" ? A() : O(), g = Math.ceil(se())) {
    ...
    for (let p = 0; p < g; p++) E.push(altchaCreateWorker(Qe()));
    const z = Math.ceil(s / g),
      k = await Promise.all(E.map((p, M) => {
        const N = M * z;
        return new Promise(Fe => {
          p.addEventListener("message", lt => {
            if (lt.data) for (const ot of E) ot !== p && ot.postMessage({
              type: "abort"
            });
            Fe(lt.data);
          }), p.postMessage({
  ...
  async function ye() {
    return nt(x.VERIFYING), await new Promise(n => setTimeout(n, u() || 0)), Bn().then(n => (wr(n), I("challenge", n), br(n))).then(({
      data: n,
      solution: s
    }) => {
      if (I("solution", s), "challenge" in n && s && !("clearText" in s)) if ((s == null ? void 0 : s.number) !== void 0) {
        if (B()) return Xn(ur(n, s));
...
dl(["change"]);
customElements.define("altcha-widget", Sl(Jl, {
  blockspam: {
    type: "Boolean"
  },
  debug: {
